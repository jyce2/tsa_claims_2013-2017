...
* NOTE: Run the program after all data preparation is complete.       							      *;                 *;
...
%let path = '~/certpractice_sql/caseStudy';
...
ods text="^{style[textalign=c fontsize=&MainTitleSize color=&MainTitleColor]TSA Claims 2013-2017}";
